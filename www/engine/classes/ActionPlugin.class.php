...
abstract class ActionPlugin extends Action
{
    ...
    public function getTemplatePathPlugin()
    {
        ...
        if (is_null($this->sTemplatePathPlugin)) {
            ...
            $aPaths = glob(LIVESTREET_PATH_WWW . "/plugins/{$aMatches[1]}/templates/skin/*/actions/Action" . ucfirst($aMatches[2]), GLOB_ONLYDIR);
            ...
            $sDir = LIVESTREET_PATH_WWW . "/plugins/{$aMatches[1]}/templates/skin/{$sTemplateName}/";
