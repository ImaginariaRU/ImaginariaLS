...
require_once LIVESTREET_PATH_ENGINE.'/lib/external/LiveImage/Image.php';
...
class ModuleImage extends Module
{
    ...
    {
        $sFileDestFullPath = rtrim( LIVESTREET_PATH_WWW, DIRECTORY_SEPARATOR ). DIRECTORY_SEPARATOR . trim( $sDirDest, DIRECTORY_SEPARATOR ) . DIRECTORY_SEPARATOR .$sFileDest;
    ...
    {
        @func_mkdir( LIVESTREET_PATH_WWW, $sDirDest );
    }
    ...
    public function GetServerPath($sPath)
    {
        ...
        return rtrim( LIVESTREET_PATH_WWW, '/' ).'/'.$sPath;
    }
    ...
    {
        $sServerPath = rtrim(LIVESTREET_PATH_WWW, '/' );
