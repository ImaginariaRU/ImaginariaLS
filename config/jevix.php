...
return array(
	'default' => array(
		...
		'cfgAllowTags' => array(
			...
			array(
				array('ls','cut','a', 'img', 'i', 'b', 'u', 's', 'video', 'em',  'small',  'strong', 'nobr', 'li', 'ol', 'ul', 'sup', 'abbr', 'sub', 'acronym', 'h4', 'h5', 'h6', 'br', 'hr', 'pre', 'code', 'object', 'param', 'embed', 'blockquote', 'iframe','table','tbody','th','tr','td','object','param'),
			),			
		),
		// Коротие теги типа
		...
		'cfgAllowTagParams' => array(
			...
			array(
				'object',
				array('width' => '#int', 'height' => '#int', 'data' => array('#domain'=>array('youtube.com','youtu.be','rutube.ru','vimeo.com','kickstarter.com','pleer.com')), 'type' => '#text')
			),
			array(
				'param',
			...
			array(
				'embed',
				array('src' => array('#domain'=>array('youtube.com','rutube.ru','vimeo.com','pleer.com','youtu.be')), 'type' => '#text','allowscriptaccess' => '#text', 'allowfullscreen' => '#text','width' => '#int', 'height' => '#int', 'flashvars'=> '#text', 'wmode'=> '#text')
			),
			array(
				'video',
				array()
			...
			array(
				'iframe',
				array('width' => '#int', 'height' => '#int', 'src' => array('#domain'=>array('youtube.com','youtu.be','rutube.ru','vimeo.com','pleer.com','kickstarter.com')))
			),
			array(
				'ls',
				array('user'=>'#text')
		...
		'cfgSetTagNoAutoBr' => array(
			array(
				array('ul','ol','object','table','tbody','tr')
			)
		),
